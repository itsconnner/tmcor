        ...
        <div className='w-full flex'>
            ...
            <div className='mx-auto mt-auto mb-auto aspect-1/1'>
                <svg width="140" height="141" viewBox="0 0 140 141" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <circle cx="70" cy="70.5" r="68.5" transform="rotate(45 70 70.5)" stroke="white" strokeWidth={3}
                            strokeDasharray="100 11"/>
                    <circle cx="70.5" cy="70.0001" r="46" stroke="white" strokeWidth={3} strokeDasharray="100 11"/>
                    <path
